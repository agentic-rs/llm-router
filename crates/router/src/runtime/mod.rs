...
pub use server::{
  ...
  authenticate_forward_proxy_client, authenticate_llm_api_client, buffer_matched_body, classify_request_kind,
  connect_upgrade_channel, handle_admitted_http, handle_forward_proxy_request, handle_llm_api_request,
  managed_response_to_axum, opaque_response_to_axum, request_body_present, AdmissionError, AdmittedHttpRequest,
  AuthBoundary, AuthorityLocation, BoxTunnelIo, BufferedRequestBody, ClientAuthError, ConnectRunError,
  ConnectRunReport, ConnectRunResult, ConnectSession, ConnectUpgrade, ConnectUpgradeReceiver, ConnectUpgradeSender,
  ConnectUpgradeUnavailableReason, ExpectedRequestTarget, ForwardProxyAdmission, GatewayEngine, GatewayEngineError,
  GatewayEngineResult, GatewayServerState, GatewayServerStateError, GatewayServerStateResult, GatewayServingDefaults,
